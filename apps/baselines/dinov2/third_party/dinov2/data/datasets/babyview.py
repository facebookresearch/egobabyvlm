...
"""BabyView frame dataset (local-FS only)."""
...
class BabyView(ExtendedVisionDataset):
    """BabyView frame dataset reading images from a local directory tree.
    ...
    def get_target(self, index: int) -> int:  # noqa: ARG002 -- BabyView has no labels.
        return index
    ...
    def dump_extra(self) -> None:
        ...
        logger.info("Creating entries for BabyView %s split", self.split.value)
