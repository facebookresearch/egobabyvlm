...
from apps.alignment_scoring.third_party.perception_models.core.utils import get_init_fn
from apps.alignment_scoring.third_party.perception_models.core.vision_projector.base import BaseProjector
